        ...
        <div class="pesquisaThing">Resultados da pesquisa por <b>"<?php echo htmlspecialchars($query) . '"</b></div>';
            ...
            <div class="projetos">
              ...
              <div class="pagination">
                <?php if ($page > 1) : ?>
                  <a href="<?= $config['URL'] ?>/resto.php<?= $coisodepagina ?>page=1">Início</a>
                  <p class="textinhoClaro">~</p>
                  <a href="<?= $config['URL'] ?>/resto.php<?= $coisodepagina ?>page=<?= $page - 1 ?>">« Anterior</a>
                  <p class="textinhoClaro">~</p>
                <?php endif ?>
                <?php if ($page == 1) : ?>
                  ...
                  <?php if ($page < $pages) : ?>
                    <p class="textinhoClaro">~</p>
                    <a href="<?= $config['URL'] ?>/resto.php<?= $coisodepagina ?>page=<?= $page + 1 ?>">Próximo »</a>
                    <p class="textinhoClaro">~</p>
                    <a href="<?= $config['URL'] ?>/resto.php<?= $coisodepagina ?>page=<?= $pages ?>">Fim</a>
                  <?php endif ?>
                  <?php if ($page == $pages) : ?>
