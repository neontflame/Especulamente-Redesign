...
(4, 'Apostador', 'apostador.png', 125, 5),
(5, 'Bicheiro', 'bicheiro.png', 200, 5),
(6, 'Investidor', 'investidor.png', 300, 5),
(7, 'Empreendedor em Potencial', 'empreendedor_potencial.png', 450, 10),
(8, 'Empreendedor em Realidade', 'empreendedor_real.png', 600, 10),
(9, 'Milhário', 'milhario.png', 1000, 10),
(10, 'Milionário', 'milionario.png', 1500, 10),
(11, 'Especulionário', 'especulionario.png', 2022, 10),
(12, 'Lagartixa', 'lagartixa.png', 2500, 25),
(13, 'Lagarto', 'lagarto.png', 2750, 25),
(14, 'Lagaaaaaarto', 'lagaaaaaarto.png', 3000, 25),
(15, 'Rinoceronte', 'rinoceronte.png', 4000, 25),
(16, 'Draguinho', 'draguinho.png', 4200, 50),
(17, 'Dragão', 'dragao.png', 4400, 50),
(18, 'Dragão Ancião', 'dragao_anciao.png', 4600, 50),
(19, 'Dragão Geriátrico', 'dragao_geriatrico.png', 4800, 50),
(20, 'Dragão Cremado', 'dragao_cremado.png', 5000, 50),
(21, 'Super Saia Jeans Deus', 'supersaiajeansdeus.png', 7000, 100),
(22, 'Ultra Saia Jeans Instinto', 'ultrasupersaiajeansinstinto.png', 8001, 100),
(23, 'Gorila', 'gorila.png', 10000, 100);
...
(7, 'Seriados/Filmes', 'Entusiastas de TV e dos telões, reúnam-se aqui!', 1),
...
--
-- Estrutura para tabela `forum_seguidas`
--

CREATE TABLE IF NOT EXISTS `forum_seguidas` (
  `id` int NOT NULL AUTO_INCREMENT,
